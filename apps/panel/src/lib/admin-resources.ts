...
export const adminResources: Record<AdminResourceKey, AdminResourceDefinition> = {
  ...
  variacoes: {
    ...
    select: "id,product_id,sku,color_name,color_hex,color_hex_secondary,size,barcode,price_override,active,updated_at",
    ...
    fields: [
      ...
      { key: "color_hex_secondary", label: "Código da segunda cor", type: "text" },
