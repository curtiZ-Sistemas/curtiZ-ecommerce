    ...
    <form onSubmit={submit}>
      <div className="homepage-editor-columns">
        ...
        <fieldset><legend>Agenda e visual</legend>
          ...
          <label><span>Fundo autorizado</span><select value={configString(value.style, "background", "default")} onChange={(event) => style("background", event.target.value)}><option value="default">Padrão</option><option value="subtle">Suave</option><option value="brand">Vermelho Curtiz</option><option value="dark">Escuro</option></select></label>
