...
select lives_ok($sql$
  select public.admin_import_product_authorized(
    ...
    '{
      ...
      "categoryId":"c7400000-0000-4000-8000-000000000002",
      "categoryIds":["c7400000-0000-4000-8000-000000000002"],
...
$sql$, 'First import executes without the invalid chr(0) lock key');
...
select is((public.admin_import_product_authorized(
