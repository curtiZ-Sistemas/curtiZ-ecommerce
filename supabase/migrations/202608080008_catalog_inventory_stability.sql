...
begin
  ...
  if pg_catalog.strpos(
    ...
    raise exception 'search_catalog aggregation did not match the expected previous migration';
  end if;
  corrected_definition := pg_catalog.replace(
  ...
  if corrected_definition = function_definition then
    raise exception 'search_catalog definition did not match the expected previous migration';
  end if;
  ...
  if corrected_definition = function_definition then
    raise exception 'get_catalog_product definition did not match the expected previous migration';
  end if;
  execute corrected_definition;
  ...
  if corrected_definition = function_definition then
    raise exception 'merge_customer_cart definition did not match the expected previous migration';
  end if;
  execute corrected_definition;
  ...
  if corrected_definition = function_definition then
    raise exception 'validate_checkout_lines definition did not match the expected previous migration';
  end if;
  execute corrected_definition;
end;
$migration$;
